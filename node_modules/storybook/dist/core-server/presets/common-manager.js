...
// ../addons/docs/src/blocks/controls/index.tsx
var LazyColorControl = lazy(() => import("../../_browser-chunks/Color-KPF66X3F.js")), ColorControl = (props) => React16.createElement(Suspense, { fallback: React16.createElement("div", null) }, React16.createElement(LazyColorControl, { ...props }));
...
function ActionLogger2({ active, api }) {
  let [actions, setActions] = useState13([]), expandLevel = useParameter2(PARAM_KEY)?.expandLevel ?? 1, clearActions = useCallback7(() => {
    ...
    setActions((prevActions) => {
      ...
      return previous && safeDeepEqual(previous.data, action.data) ? previous.count++ : (action.count = 1, newActions.push(action)), newActions.slice(0, action.options.limit);
    });
...
import React55, { Fragment as Fragment3, memo as memo4, useEffect as useEffect16, useMemo as useMemo6, useRef as useRef6, useState as useState20 } from "react";
import {
  FORCE_REMOUNT,
...
import React60, { useCallback as useCallback9, useEffect as useEffect17 } from "react";
...
import React63, { memo as memo6, useCallback as useCallback10, useEffect as useEffect18 } from "react";
...
import { useCallback as useCallback11, useEffect as useEffect19, useMemo as useMemo7, useRef as useRef7 } from "react";
...
var URL_VALUE_PATTERN = /^([0-9]{1,4})([a-z]{0,4})-([0-9]{1,4})([a-z]{0,4})$/, VIEWPORT_MIN_WIDTH = 40, VIEWPORT_MIN_HEIGHT = 40, cycle = (viewports, current, direction = 1) => {
  ...
  }, [parameter, storyGlobals, options, option, update]), useEffect19(() => {
