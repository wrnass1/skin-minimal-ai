import CJS_COMPAT_NODE_URL_5wtsz597zu from 'node:url';
import CJS_COMPAT_NODE_PATH_5wtsz597zu from 'node:path';
import CJS_COMPAT_NODE_MODULE_5wtsz597zu from "node:module";

var __filename = CJS_COMPAT_NODE_URL_5wtsz597zu.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_5wtsz597zu.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_5wtsz597zu.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-7XXRDDNS.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-AGHTU7SX.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-DJGIYECC.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-FKYU5AIJ.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
