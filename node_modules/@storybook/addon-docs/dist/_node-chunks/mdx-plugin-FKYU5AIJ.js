...
import {
  compile
} from "./chunk-IZTOCZI6.js";
import "./chunk-XQVCPLVF.js";
import "./chunk-DKIGYCRM.js";
import {
  __commonJS,
  __toESM
} from "./chunk-7XXRDDNS.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-AGHTU7SX.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-DJGIYECC.js")).default;
  return {
