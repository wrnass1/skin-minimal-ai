...
var require_react_innertext = __commonJS({
  "../../../node_modules/react-innertext/index.js"(exports, module) {
    ...
    }, innerText2 = function(jsx) {
      return jsx === null || typeof jsx == "boolean" || typeof jsx > "u" ? "" : typeof jsx == "number" ? jsx.toString() : typeof jsx == "string" ? jsx : Array.isArray(jsx) ? jsx.reduce(reduceJsxToString, "") : hasProps(jsx) && Object.prototype.hasOwnProperty.call(jsx.props, "children") ? innerText2(jsx.props.children) : "";
    };
...
var require_checkPropTypes = __commonJS({
  "../../../node_modules/prop-types/checkPropTypes.js"(exports, module) {
    ...
    process.env.NODE_ENV !== "production" && (ReactPropTypesSecret = require_ReactPropTypesSecret(), loggedTypeFailures = {}, has = require_has(), printWarning = function(text) {
...
function getStyleComputedProperty(element, property) {
  if (element.nodeType !== 1)
    return [];
  var window2 = element.ownerDocument.defaultView, css = window2.getComputedStyle(element, null);
...
function isIE(version) {
  return version === 11 ? isIE11 : version === 10 ? isIE10 : isIE11 || isIE10;
}
...
function treeChanges2(previousData, data) {
  ...
  var added = function(key, value) {
    ...
    return esm_default2.defined(key) ? (process.env.NODE_ENV === "development" && console.warn("`changedTo` is deprecated! Replace it with `change`"), changed(key, actual)) : !1;
...
var STATUS = { INIT: "init", IDLE: "idle", OPENING: "opening", OPEN: "open", CLOSING: "closing", ERROR: "error" }, isReact16 = ReactDOM.createPortal !== void 0;
function canUseDOM() {
...
var ReactFloaterPortal = (function(_React$Component) {
  ...
  return _createClass(ReactFloaterPortal2, [{ key: "componentDidMount", value: function() {
    ...
    !canUseDOM() || !this.node || (isReact16 || ReactDOM.unmountComponentAtNode(this.node), this.node && this.node.parentNode === document.body && (document.body.removeChild(this.node), this.node = void 0));
...
var __defProp = Object.defineProperty, __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __publicField = (obj, key, value) => __defNormalProp(obj, typeof key != "symbol" ? key + "" : key, value), ACTIONS = {
  INIT: "init",
  START: "start",
  STOP: "stop",
  RESET: "reset",
...
function getElement(element) {
  if (typeof element == "string")
    try {
      ...
      return process.env.NODE_ENV !== "production" && console.error(error), null;
    }
  return element;
}
...
var Spotlight_default = JoyrideSpotlight, JoyrideOverlay = class extends React2.Component {
  ...
  componentDidMount() {
    ...
    this.scrollParent = getScrollParent2(element ?? document.body, disableScrollParentFix, !0), this.isActive = !0, process.env.NODE_ENV !== "production" && !disableScrolling && hasCustomScrollParent(element, !0) && log2({
...
}, JoyridePortal = class extends React32.Component {
  constructor() {
  ...
  componentWillUnmount() {
    !canUseDOM2() || !this.node || (isReact162 || ReactDOM2.unmountComponentAtNode(this.node), this.node.parentNode === document.body && (document.body.removeChild(this.node), this.node = null));
  }
  renderReact15() {
    if (!canUseDOM2())
      return;
    let { children } = this.props;
    this.node && ReactDOM2.unstable_renderSubtreeIntoContainer(this, children, this.node);
  }
  renderReact16() {
    if (!canUseDOM2() || !isReact162)
      return null;
    let { children } = this.props;
    return this.node ? ReactDOM2.createPortal(children, this.node) : null;
  }
  render() {
...
}, JoyrideBeacon = class extends React4.Component {
  constructor(props) {
  ...
  componentDidMount() {
    ...
    process.env.NODE_ENV !== "production" && (src_default.domElement(this.beacon) || console.warn("beacon is not a valid DOM element")), setTimeout(() => {
  ...
  render() {
    ...
    return beaconComponent ? component = React4.createElement(
      beaconComponent,
      {
        continuous,
        index,
...
function JoyrideTooltipContainer(props) {
  ...
  return output.primary = React6.createElement(
    "button",
    {
  ...
  ), showSkipButton && !isLastStep && (output.skip = React6.createElement(
    "button",
    {
      "aria-live": "off",
  ...
  )), !hideBackButton && index > 0 && (output.back = React6.createElement("button", { "data-test-id": "button-back", style: styles.buttonBack, type: "button", ...backProps })), output.close = !hideCloseButton && React6.createElement(CloseButton_default, { "data-test-id": "button-close", styles: styles.buttonClose, ...closeProps }), React6.createElement(
    "div",
    {
      key: "JoyrideTooltip",
...
var Container_default = JoyrideTooltipContainer, JoyrideTooltip = class extends React7.Component {
  constructor() {
...
}, JoyrideStep = class extends React8.Component {
  constructor() {
  ...
  render() {
    ...
    return !validateStep(step) || !src_default.domElement(target) ? null : React8.createElement("div", { key: `JoyrideStep-${index}`, className: "react-joyride__step" }, React8.createElement(
      ReactFloater,
      {
        ...step.floaterProps,
...
}, Joyride = class extends React9.Component {
  constructor(props) {
